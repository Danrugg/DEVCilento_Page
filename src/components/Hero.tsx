        ...
        <section className="min-h-[90vh] flex items-center justify-center pt-32 pb-12 px-4 sm:px-6 overflow-hidden">
            <div className="w-full flex flex-col items-center text-center gap-8">
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold tracking-tight text-black max-w-2xl mt-4 px-4">
                    Costruiamo l'infrastruttura digitale del tuo successo
                </h2>

                {/* Description */}
                <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed">
                    Rendiamo i tuoi processi fluidi e le tue vendite scalabili. Dallo sviluppo di software personalizzati alla gestione intelligente dei dati, creiamo soluzioni digitali progettate per eliminare le inefficienze e potenziare ogni tua decisione di business.
                </p>

                {/* CTA Button */}
                <div className="mt-8">
                    <a
                        href="https://wa.me/393715566672?text=Ciao%20%2C%20vorrei%20richiedere%20un%20preventivo%20gratuito!"
                        target="_blank"
